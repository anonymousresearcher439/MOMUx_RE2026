...
| S20 | Use of different altitude reference frames across roles led to difficulty interpreting altitude information consistently. | Geospatial Understanding and Representation Alignment |
| S21 | Cardinal-based telemetry and map views did not align with operator perspective, leading to discrepancies in spatial understanding. | Geospatial Understanding and Representation Alignment |
| S22 | Different location estimates between roles created discrepancies in shared spatial understanding. | Geospatial Understanding and Representation Alignment |
